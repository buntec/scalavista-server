...
case class PosAtRequest(filename: String, fileContents: String, offset: Int) extends Request

case class DocAtRequest(filename: String, fileContents: String, offset: Int) extends Request
...
case class ScopeCompletionRequest(filename: String, fileContents: String, offset: Int) extends Request
